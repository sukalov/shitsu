        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-neutral-600 leading-relaxed">
              <p>
                Я художница и иллюстратор, работаю в различных техниках и
                стилях. Мои работы — это исследование эмоций, форм и цвета.
                Каждая картина — это история, которую я хочу рассказать.
              </p>
              <p>
                В моём магазине вы найдёте оригинальные работы, принты и мерч.
                Также я принимаю индивидуальные заказы — буду рада воплотить
                вашу идею в жизнь.
              </p>
              <p>
                Искусство — это способ общения без слов. Надеюсь, мои работы
                найдут отклик в вашем сердце.
              </p>
            </div>
          </div>
